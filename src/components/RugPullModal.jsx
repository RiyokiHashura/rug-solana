...
const CHAOS_MESSAGES = [
  ...
  "Enter the Financial Circus 🎭💸",
  "Join the Meme Moshpit 🤘🔥",
  "Enter the Degen Zone 🫡🚀",
  "Join the Crypto Carnival 🎡💎",
  "Enter Peak Chaos Hours 🌋😂",
  "Join the Diamond Hands 💎🙌",
  "Enter the Bull Run 🐂📈",
  "Join the Profit Party 🎉💰",
  "Enter the Moon Mission 🌕🚀"
];
